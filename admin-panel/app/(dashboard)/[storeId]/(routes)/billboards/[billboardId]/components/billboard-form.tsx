...
const formSchema = z.object({
  label: z.string().min(1, 'O nome precisa pelo menos 1 caracter.'),
  imageUrl: z.string().min(1, 'Url da imagem inválida'),
});
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder="Nome do painel de controle da loja"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
